...
```
| Component                 |  Port | Protocol   | Nginx HTTP proxy? Not for HF students            |
| ------------------------- | ----: | ---------- | ---------------------------- |
...
```
sudo ss -lntp |
  grep -E ':(9870|9864|8088|8042|19888|9000|9866|9867|8030|8031|8032|8033|10020)\b'
```
